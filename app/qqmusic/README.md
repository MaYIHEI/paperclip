...
| `qqmusic_task_favorite` | `true` | 自动完成“收藏一首歌曲”:临时收藏榜单歌曲,领奖后取消收藏 |
...
- **每日任务**:自动领取所有已经完成的奖励;“定时领金币”到点即可领,“收藏一首歌曲”会临时收藏后恢复。听歌、听书、分享、通知权限等前置行为仍需真实 App 行为。
- **广告任务**:看视频、广告翻倍、跳转京东需要广告 SDK 票据,不会自动执行。

## 维护记录

| 日期 | 变更 |
|---|---|
| 2026-07-12 | 新增金币签到、App 动态签名、每日任务领奖与临时收藏歌曲任务 |
